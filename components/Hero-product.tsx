export default function Hero() {
  return (
    <section className="pt-10 h-[70vh] bg-[#F6F6F6] rounded-3xl w-[88%] mt-36 mx-auto pb-16 overflow-hidden relative">
      <img className="absolute w-[100%] h-[78vh] mt-[-40px] z-0" src="/product-hero.png" alt="" />
      <div className="max-w-9xl relative z-10 mx-auto w-[92%] px-4 sm:px-6 lg:px-3">
        {/* Top mini-banner */}
